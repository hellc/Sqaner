...
extension CGAffineTransform {
    ...
    /// - Returns: The transform that will make the `fromSize` parameter fir (aspect fill)
    /// inside the `toSize` parameter.
    ...
    /// - Returns: The transform that will translate the center of the `fromRect` parameter
    /// to the center of the `toRect` parameter.
